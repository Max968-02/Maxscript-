...
padding.PaddingTop, padding.PaddingLeft = UDim.new(0, 12), UDim.new(0, 16)
padding.PaddingRight, padding.PaddingBottom = UDim.new(0, 16), UDim.new(0, 12)
...
body.TextXAlignment, body.TextYAlignment = Enum.TextXAlignment.Left, Enum.TextYAlignment.Top
body.Font, body.TextSize = Enum.Font.Gotham, 18
body.TextWrapped, body.RichText = true, true
...
button.MouseButton1Click:Connect(function()
	...
	-- Loading Text (Max SCRIPT Loading...)
	...
	textLabel.TextStrokeColor3 = Color3.fromRGB(0, 0, 0) -- itim outline
